	...
	<div class = "well">
		...
		<div class = "panel panel-success">	
			...
			?>
				...
				<a style = "float:right; margin-top:-4px;" href = "urinalysis.php" class = "btn btn-success"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
				
				<a style = "float:right; margin-top:-4px; margin-right:5px;" href = "urinalysis_pending.php?itr_no=<?php echo $f['itr_no']?>" class = "btn btn-success">REQUEST <span class = "badge"> <?php echo $f1['total']?></span></a>
