...
<br /><br /><br /><br /><br /><br /><br />
  <div class="ts-main-content">	
		...
		<?php
			...
			$f1 = $q1->fetch_array();
		?>
		<div class = "alert alert-success">Fecalysis Record / <?php echo $f1['firstname']." ".substr($f1['middlename'], 0, 1).". ".$f1['lastname']?><a class = "btn btn-success" style = "float:right; margin-top:-7px;" href = "home.php"><span class = "glyphicon glyphicon-hand-right"></span> Back</a></div>
		<table id = "table" cellspacing = "0" class = "display">
			...
			<tbody>
			<?php 
				$q = $conn->query("SELECT * FROM `fecalisys` NATURAL JOIN `itr` WHERE `itr_no` = '$_SESSION[itr_no]' ORDER BY `date_reported` DESC") or die(mysqli_error());
			...
			?>
				<tr>
					...
					<td><center><a href = "fecalysis_form.php?itr_no=<?php echo $f['itr_no']?>&fecalysis_id=<?php echo $f['fecalysis_id']?>" class = "btn btn-success"><span class = "glyphicon glyphicon-search"></span> View Detail</a><center></td>
				</tr>
			<?php
				}
			?>	
