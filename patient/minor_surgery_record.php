...
<br /><br /><br /><br /><br /><br /><br />
  <div class="ts-main-content">	
		...
		?>
		<br />
		<div class = "alert alert-success">Minor Surgery Record / <?php echo $f1['firstname']." ".substr($f1['middlename'], 0, 1).". ".$f1['lastname']?>
		...
		<table id = "table" cellspacing = "0" class = "display">
			...
			<?php 
				$conn = new mysqli("localhost","root","","hcpms") or die(mysqli_error());
				$q = $conn->query("SELECT * FROM `minor_surgery` NATURAL JOIN `itr` WHERE `itr_no` = '$_SESSION[itr_no]' ORDER BY `surgery_id` DESC") or die(mysqli_error());
			...
			?>
				<tr>
					...
					<td><center><a class = "btn btn-success" href = "minor_surgery_form.php?itr_no=<?php echo $f['itr_no']?>&surgery_id=<?php echo $f['surgery_id']?>"><span class = "glyphicon glyphicon-search"></span> View Detail</a><center></td>
				</tr>
			<?php
				}
			?>	
